...
export default function Analise() {
  ...
  // Componente customizado para label acima da barra
  ...
  // Barra customizada com cor fixa — sem mudança no hover
            ...
            {loteData.length > 0 && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                <div className="flex items-center justify-between mb-5">
                  <div>
                    <h2 className="text-sm font-semibold text-gray-800">Rejeições por lote</h2>
                    <p className="text-xs text-gray-400 mt-0.5">Distribuição por lote de produção</p>
                  </div>
                ...
                <ResponsiveContainer width="100%" height={220}>
                  <BarChart
                    ...
                    <Tooltip
                      ...
                      formatter={(value: any) => [`${value} rejeições`, "Lote"]}
                    />
                    <Bar
                      dataKey="count"
                      fill={RED}
                      ...
                      name="Rejeições"
                      label={{ position: "top", fill: RED, fontSize: 11, fontWeight: 600 }}
                    />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              {labData && (
                <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl mb-4 text-xs font-medium
                  ...
                  <span className={`w-2 h-2 rounded-full shrink-0 ${consistente ? "bg-emerald-500" : "bg-amber-500"}`} />
